...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/lib/codemirror.css?v=5.2.1deb3">
  <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/addon/hint/show-hint.css?v=5.2.1deb3">
  <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/addon/lint/lint.css?v=5.2.1deb3">
  <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.2.1deb3">
  <title>localhost / localhost | phpMyAdmin 5.2.1deb3</title>
    <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.min.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-migrate.min.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/sprintf.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/ajax.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/keyhandler.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-ui.min.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/name-conflict-fixes.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/bootstrap/bootstrap.bundle.min.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/js.cookie.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.validate.min.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-ui-timepicker-addon.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.debounce-1.0.6.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/menu_resizer.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/cross_framing_protection.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/config.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/doclinks.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/functions.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/navigation.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/indexes.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/common.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/page_settings.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/lib/codemirror.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/mode/sql/sql.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/runmode/runmode.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/hint/show-hint.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/hint/sql-hint.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/lint/lint.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/codemirror/addon/lint/sql-lint.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/tracekit.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/error_report.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/drag_drop_import.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/shortcuts_handler.js?v=5.2.1deb3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/console.js?v=5.2.1deb3"></script>

<script data-cfasync="false" type="text/javascript">
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"47474924636d4e67796339647c5c5c23",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1deb3",auth_type:"cookie",user:"fauzan"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=events">
    `qrattend`.`events`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=ticket_attendees">
    `qrattend`.`ticket_attendees`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=transactions">
    `qrattend`.`transactions`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=tickets">
    `qrattend`.`tickets`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=event_committees">
    `qrattend`.`event_committees`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=users">
    `qrattend`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=qrattend&table=user_verifications">
    `qrattend`.`user_verifications`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cXJhdHRlbmQ=" data-vpath="cm9vdA==.cXJhdHRlbmQ=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=qrattend"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=qrattend" title="Structure">qrattend</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="47474924636d4e67796339647c5c5c23">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="localhost:3306" draggable="false">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="qrattend" targettable="events">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="event_committees">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `event_committees`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="event_committees">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="tickets">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tickets`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="tickets">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `events`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="transactions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `transactions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="transactions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `transactions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="ticket_attendees">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `ticket_attendees`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="qrattend" targettable="events">
                            <div class="action_content">
